...
<template>
  <footer class="bg-brand-navy-dark text-white py-12">
    <div class="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row justify-between items-center gap-6">
      <div>
        <a href="#" class="text-2xl font-heading font-bold text-white">
          Durubond<span class="text-brand-gold">.</span>
        </a>
      ...
      <div class="flex items-center gap-6">
        <a href="#" class="text-white/70 hover:text-brand-gold transition-colors">
    ...
    <div class="max-w-7xl mx-auto px-6 md:px-12 mt-8 pt-8 border-t border-white/10 text-center md:text-left text-sm text-white/40">
      &copy; {{ new Date().getFullYear() }} Durubond Real Estate. All rights reserved.
    </div>
  </footer>
</template>
